...
public class Formas extends javax.swing.JFrame {
    ...
    public void paint(Graphics g){
        ...
        g.drawRect(120,50,100,120);
        g.drawOval(230,50,100,100);
        g.drawRoundRect(460, 50, 100, 100, 10, 10);
        
        int vectorx[] = {400,350,450};
        int vectory[] = {50,120,120};
        g.drawPolygon(vectorx,vectory,3);

        g.setColor(Color.GREEN);
        
        g.fillRect(120,190,100,120);
        g.fillOval(230,190,100,100);
        g.fillRoundRect(460, 190, 100, 100, 10, 10);
        
        int vectorx2[] = {400,350,450};
        int vectory2[] = {190,250,250};
